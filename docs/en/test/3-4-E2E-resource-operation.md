...
- `createNetworkPolicy`
  ...
  - Take port modification QoS as an example: `test/e2e/integration/pages/network/port.spec.js`
...
- `createSecurityGroup`
  ...
  - Take the port card as an example: `test/e2e/integration/pages/network/port.spec.js`
